...
function checkfi() {
    var v = (document.getElementById("first") as HTMLInputElement).value;
...
function checkusername() {
    var error = null;
    var v = (document.getElementById("gainus") as HTMLInputElement).value,
        s = document.getElementById("gainus").style;
    ...
    if (error != null) {
        ...
        document.getElementById("Eusername").style.color = "#ffcc00";
...
function pass() {
    var error = null;
    var v = (document.getElementById("pass") as HTMLInputElement).value,
        s = document.getElementById("pass").style;
...
function phone() {
    var error = null;
    var v = (document.getElementById("phone") as HTMLInputElement).value,
        s = document.getElementById("phone").style
