...
namespace Project_Gym.SmsSender {
    ...
    public partial class SMSSender : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public SMSSender() {
            this.Url = global::Project_Gym.Properties.Settings.Default.Project_Gym_SmsSender_SMSSender;
        ...
        public string sendSMS() {
            object[] results = this.Invoke("sendSMS", new object[0]);
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void sendSMSAsync() {
            this.sendSMSAsync(null);
        }
        
        /// <remarks/>
        public void sendSMSAsync(object userState) {
            if ((this.sendSMSOperationCompleted == null)) {
                this.sendSMSOperationCompleted = new System.Threading.SendOrPostCallback(this.OnsendSMSOperationCompleted);
            }
            this.InvokeAsync("sendSMS", new object[0], this.sendSMSOperationCompleted, userState);
        }
