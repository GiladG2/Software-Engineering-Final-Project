...
ALTER TABLE dbo.tblExercise_List DROP CONSTRAINT FK_Exercise_MuscleGroup;
ALTER TABLE dbo.tblExercise_List DROP CONSTRAINT FK_Exercise_TimeToComplete;
ALTER TABLE dbo.tblMuscles_Worked_In_Exercises DROP CONSTRAINT FK_tblMuscles_Worked_In_Exercises_fldExercise_Id;
ALTER TABLE dbo.tblMuscles_Worked_In_Exercises DROP CONSTRAINT FK_tblMuscles_Worked_In_Exercises_fldMuscle_Id;
