...
namespace TestWs2.localhost {
    ...
    public partial class Practice : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Practice() {
            this.Url = global::TestWs2.Properties.Settings.Default.TestWs2_localhost_Practice;
        ...
        public System.Data.DataSet GetDataSet(string tbName) {
        ...
        /// <remarks/>
        public void GetDataSetAsync(string tbName) {
            this.GetDataSetAsync(tbName, null);
        }
        
        /// <remarks/>
        public void GetDataSetAsync(string tbName, object userState) {
            ...
            this.InvokeAsync("GetDataSet", new object[] {
                        tbName}, this.GetDataSetOperationCompleted, userState);
        }
